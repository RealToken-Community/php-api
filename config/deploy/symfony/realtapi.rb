    ...
    task :realt do
        on roles(:staging) do
            within release_path do
                ...
                execute "'cd /home/realt/docker/api/preprod && chown -R realt:docker current'"
                execute "runuser", "-l", "realt", "-c", "'pwd && cd /home/realt/docker/api/preprod && ./current/.circleci/continous_deployment.sh'"
#                 execute "pwd"
#                 execute "ls", "-lah"
